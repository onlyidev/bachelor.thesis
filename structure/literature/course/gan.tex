...
\begin{describeFramework}{MalGAN}{\cite{huGeneratingAdversarialMalware2017}}
    \introLastPar{
        Tai vienas iš pirmųjų ir populiariausių \gls{gan} tipo modelių ERROR\gls{framework}. \enquote{Juodos dėžės} detektoriai čia apibrėžiami kaip populiarūs \gls{ml} klasifikatoriai, tokie, kaip MLP \angl{Multilayer Perceptron}, RF \angl{Random Forest}, DT \angl{Decision Tree}, \gls{svm} \angl{Support Vector Machine}.
    }
    \purpose{
