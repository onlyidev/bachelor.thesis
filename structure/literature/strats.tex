...
\strat~\angl{gradient hiding} -- tai metodas, kai pasirenkama klasifikatoriaus architektūra, kurioje nefigūruoja gradientai, pavyzdžiui, nediferencijuojami modeliai, tokie kaip atsitiktinis miškas \angl{random forest}. Dėl \gls{ae} perkeliamumo \skyrius{sec:literature:transfer} ši strategija yra neveiksminga prieš \glsplka{blackBoxAttack} \cite{chakrabortySurveyAdversarialAttacks2021}.
