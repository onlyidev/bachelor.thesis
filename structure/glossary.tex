...
\newglossaryentry{policy}{
    ...
    description={Tai funkcija $\pi : S \times A \rightarrow \set{0,1}$, čia $S$ -- galimų būsenų erdvė \angl{State Space}, $A$ -- galimų veiksmų erdvė \angl{Action Space}. Šią funkciją \gls{rl} modelis \enquote{išmoksta} mokymosi metu},
