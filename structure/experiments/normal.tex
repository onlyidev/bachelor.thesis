\subsection{Originalaus klasifikatoriaus tikslumo nustatymas}% Show graphs and classification results when hit with obfuscation
...
\begin{table}[h]
    ...
    \centering
    \exptable[0,617]{tables/normal_2x2.csv}
